...
public class OrderServiceImpl implements OrderService {
    ...
    public void canceledOrder(Long id) {
         orderRepository.canceledOrder(id);
    }
    @Override
    public void reOrder(Long id){
        orderRepository.reOrder(id);
    }
    ...
    @Override
    public List<Long> isReviewed(Customer customer, Long product_id) {
        return orderRepository.isReviewed(customer.getId(),product_id);
    }
}
